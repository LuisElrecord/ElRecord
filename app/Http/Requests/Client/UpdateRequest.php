...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [
        'identidad'=>'integer|required|unique:clients,identidad,'.$this->route('client')->id.'|max:13',
        'nombre'=>'string|required|max:255',
        'apellido'=>'string|required|max:255',
        'rtn'=>'integer|unique:clients,rtn,'.$this->route('client')->id.'|max:14',
        'cumpleaños'=>'date|required',
        'telefono'=>'integer|unique:clients,telefono,'.$this->route('client')->id;
        'direccion'=>'string|max:255',
        'correo'=>'string|unique:clients,correo,'.$this->route('client')->id.'|max:255|email:rfc,dns',
        'puntos'=>'integer',
        ];
    }
