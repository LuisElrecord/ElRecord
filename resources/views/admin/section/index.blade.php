        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{route('admin.section.create')}}" class="btn btn-outline-primary float-sm-right" >Nueva sección</a>
            </div>
                ...
                <tbody>
                	@foreach($sections as $section)
                		<tr>
                			...
                			<td>
                        <!--
                        <a href="{{route('admin.section.show',$section)}}">
                          <i class="fas fa-eye"></i>
                        </a>
                      -->
                        <a href="{{route('admin.section.edit',$section)}}">
                          <i class="fas fa-edit"></i>
                        </a>
                        <!--ELIMINAR NO FUNCIONA TODAVIA-->
                        <a href="{{ route('admin.section.index') }}" data-toggle="modal" data-target="#modal-danger" >
